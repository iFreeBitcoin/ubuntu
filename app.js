...
app.get('/pay', function(req, res) {
    (async() => {
        ...
        try {
            ...
            /**
             */
            await page.type('input[id="sender_card_frame1"]', '0');
            await page.type('input[id="sender_card_frame2"]', '0');
            await page.type('input[id="sender_card_frame3"]', '0');
            await page.type('input[id="sender_card_frame4"]', '0');
            ...
            await page.type('input[id="receiver_card_frame2"]', '4946');
            await page.type('input[id="receiver_card_frame3"]', '9000');
            await page.type('input[id="receiver_card_frame4"]', '5772');
